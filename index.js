...
function createMenuItem(name, price, category) {
	const menu = { name: name, price: price, category: category };
	return menu;
}
...
console.log(createMenuItem("kid's meal", 2, "lunch"));
console.log(createMenuItem("mystery meat", 1, "all day"));
...
const johnReview = {
	name: "John",
	rating: 1,
	feedback: "This place sux bruh",
};

reviews.push(johnReview);
console.log(reviews);
...
function getReviewByIndex(revArr, indNum) {
	return `${revArr[indNum].name} gave the restaurant a ${revArr[indNum].rating} star review, and their feedback was: ${revArr[indNum].feedback}`;
}
...
function getLastReview(revArr) {
	return `${revArr[revArr.length - 1].name} gave the restaurant a ${
		revArr[revArr.length - 1].rating
	} star review, and their feedback was: ${revArr[revArr.length - 1].feedback}`;
}
